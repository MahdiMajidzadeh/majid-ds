...
window.mds.registerCommand = (Alpine) => {
    if (window.mds.commandRegistered) return
    window.mds.commandRegistered = true
...
if (window.Alpine) {
    window.mds.registerCommand(window.Alpine)
} else {
    document.addEventListener('alpine:init', () => window.mds.registerCommand(window.Alpine))
}
</script>
@endonce
